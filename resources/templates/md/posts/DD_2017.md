...
means the TES data is affected by this bias. The DDFT data whilst recorded from turns 1-5+ has been converted
to correspond with the TES and ANT range of 1-4+.
...
is still marginally faster than ANT. Following on from this point again Nanda had real concerns that 
...
that DDFT is still alive, it's still relatively competitive (match win % at the time of writing is 56.69%)
